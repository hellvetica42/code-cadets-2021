...
const getBetByIdPath = "/bet/:id"
const getUserBetsPath = "/user/:id/bets"
const getBetsByStatusPath = "/bets/"
...
func (w *WebServer) registerRoutes(ctrl Controller) {
	w.router.GET(getBetByIdPath, ctrl.GetBetByID())
	w.router.GET(getUserBetsPath, ctrl.GetUserBets())
	w.router.GET(getBetsByStatusPath, ctrl.GetBetsByStatus())
}
