...
type rabbitConfig struct {
	ConsumerEventReceivedQueue string `split_words:"true" required:"true"`
	ConsumerBetReceivedQueue   string `split_words:"true" required:"true"`
	ConsumerEventReceivedName  string `split_words:"true" default:"calculatorreceived"`
	ConsumerBetReceivedName    string `split_words:"true" default:"calculatorcalculated"`
